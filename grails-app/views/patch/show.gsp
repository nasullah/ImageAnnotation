...
<html>
    ...
    <body>
        ...
        <div id="show-patch" class="content scaffold-show" role="main">
            ...
            <f:display bean="patch" />
            <g:form resource="${this.patch}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.patch}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
