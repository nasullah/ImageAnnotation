...
<html>
    ...
    <body>
        ...
        <div id="show-label" class="content scaffold-show" role="main">
            ...
            <f:display bean="label" />
            <g:form resource="${this.label}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.label}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
